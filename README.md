...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/6010629c7cc3970015a110e1
...
To start editing your site, you can use the Sanity interface at https://bcmc-website-0629c.sanity.studio/.
...
Generated at `2021-01-26T18:45:24.006Z` by Stackbit version `0.3.44`.